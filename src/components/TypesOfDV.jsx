    ...
    <>
      ...
      <div className='flex flex-col font-montserrat gap-10 p-10 bg-green-100 text-lg lg:px-24'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10  '>
          <div className='flex flex-col gap-5'>
            <img src={es1}/>
            <h4 className='font-bold text-lg' >Physical Abuse</h4>
          ...
          <div className='flex flex-col gap-5'>
            <img src={es2}/>
            <h4 className='font-bold text-lg' >Emotional or Psychological Abuse:</h4>
          ...
          <div className='flex flex-col gap-5'>
            <img src={es3}/>
            <h4 className='font-bold text-lg' >Sexual Abuse</h4>
          ...
          <div className='flex flex-col gap-5'>
            <img src={es4}/>
            <h4 className='font-bold text-lg' >Financial Abuse</h4>
          ...
          <div className='flex flex-col gap-5'>
            <img src={es5}/>
            <h4 className='font-bold text-lg' >Digital or Technological Abuse</h4>
          ...
          <div className='flex flex-col gap-5'>
            <img src={es6}/>
            <h4 className='font-bold text-lg' >Stalking</h4>
          ...
          <div className='flex flex-col gap-5'>
            <img src={es7}/>
            <h4 className='font-bold text-lg' >Cultural or Identity-based Abuse</h4>
          ...
          <div className='flex flex-col gap-5'>
            <img src={es8}/>
            <h4 className='font-bold text-lg' >Spiritual Abuse</h4>
          ...
          <div className='flex flex-col gap-5'>
            <img src={es9}/>
            <h4 className='font-bold text-lg' >Isolation</h4>
