       ...
       <div>
			...
			<div className="font-montserrat p-10">
					<div className="flex flex-col md:flex-row justify-center gap-10 ">
						...
						<div className="content w-fit flex flex-col pt-10 pl-10 gap-5">
			...
			<div className="font-montserrat p-10 flex gap-10">
				<div className="what-we-do-left-box">
					<h4 className="text-5xl font-bold underline underline-offset-8  decoration-green-600">What we do?</h4>
