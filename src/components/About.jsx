...
export default function About() {
    return (
       <div>
                ...
                <div className="who-we-are">
                        <div className="who-we-are-images-contents">
                                <div className="image-1-box">
                                        <img className="image-1" src="./assets/About_WhoWeAre/image40.svg" />
                                </div>
                               <div className="image-2-box">
                                        <img className="image-2" src="./assets/About_WhoWeAre/image39.svg" />
                                </div>
                                <div className="who-we-are-contents-box">
                                        <h4  className="who-we-are-content-title">
                                        Who We Are
                                        </h4>
                                        <p className="who-we-are-content-p">
  ...
  <path d="M7.5 15L12.5 10L7.5 5" stroke="#147952" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
                                        </div>
